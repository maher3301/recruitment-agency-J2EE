...
/**
 * Servlet implementation class PreOffre
 */
public class PreOffre extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Offre> listOffre = dao.getAllOffres();
		request.setAttribute("liste", listOffre);
